...
if __name__ == '__main__':
    ...
    api_key = "AIzaSyAVa-P3sfHV3suB7wvxdXhMI_YGwOcqqg4"
    api_name = "youtube"
    api_version = "v3"
...
# #Escolhendo o modelo que vai ser utilizado(Devo escolher melhor)
# algoritmo = SVD()
...
# #Fazendo
# previsao = algoritmo.test(testset)

# #erro quadrado médio
# mse = accuracy.mse(previsao)

# #raiz do erro quadrático médio
# rmse = accuracy.rmse(previsao)
